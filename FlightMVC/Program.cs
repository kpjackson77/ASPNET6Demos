...
namespace FlightMVC
{
  public class Program
  {
    public static void Main(string[] args)
    {
      ...
      builder.Services.Configure<ConfigData>(builder.Configuration.GetSection("CustomItems"));
      ...
      app.MapRazorPages();
      //CreateUserRoles(builder.Services.BuildServiceProvider()).Wait();//app.Services).Wait();
      app.Run();
    }
    private static async Task CreateUserRoles(IServiceProvider serviceProvider)
    {
      ...
      if (!roleCheck)
      {
        ...
        {
          var user = await userManager.FindByEmailAsync("fred@fred.com");
